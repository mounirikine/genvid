          ...
          <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div className="flex-1">
              <div className="text-center">
                ...
                <p className="mt-3 text-gray-500 :text-gray-300">Create an account to get started</p>
              </div>

              <div className="mt-8">
                <form>
                  <div>
                    <label htmlFor="username" className="block mb-2 text-sm text-gray-600 :text-gray-200">Username</label>
                    <input type="text" name="username" id="username" placeholder="Your Username" className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg :placeholder-gray-600 :bg-gray-900 :text-gray-300 :border-gray-700 focus:border-indigo-400 :focus:border-indigo-400 focus:ring-indigo-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                  </div>
                  ...
                  <div className="mt-6">
                    <label htmlFor="password" className="block mb-2 text-sm text-gray-600 :text-gray-200">Password</label>
                  ...
                  <div className="mt-6">
                    <label htmlFor="confirm-password" className="block mb-2 text-sm text-gray-600 :text-gray-200">Confirm Password</label>
                ...
                <p className="mt-6 text-sm text-center text-gray-400">Already have an account? <Link to="/login" className="text-indigo-500 focus:outline-none focus:underline hover:underline">Sign in</Link>.</p>
              </div>
            </div>
          </div>
        </div>
