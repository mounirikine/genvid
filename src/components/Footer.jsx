...
const Footer = () => {
  return (
    <footer className="mt-auto w-full max-w-full py-10 body text-white px-4 sm:px-6 lg:px-8 mx-auto">
      <div className="text-center">
        ...
        <div className="mt-3">
          ...
          <p className="text-gray-500 dark:text-neutral-500">© selerions. 2024 Htmlstream. All rights reserved.</p>
        </div>
