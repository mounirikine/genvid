              ...
              <div className="drawer">
                ...
                <div className="drawer-side">
                  ...
                  <ul className="menu bg-indigo-950 text-base-content min-h-full w-80 p-4">
                    ...
                    <li>
                      <Link to="/" className={`block py-2 px-3 md:p-0 rounded ${location.pathname === '/' ? (isScrolled ? 'text-gray-200 hover:bg-gray-100' : 'text-white bg-indigo-700 md:bg-transparent md:text-indigo-700 md:dark:text-indigo-500') : (isScrolled ? 'text-gray-900 hover:bg-gray-100' : 'text-gray-900 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700')}`} aria-current="page">Home</Link>
                    </li>
                    <li>
                      <Link to="/about" className={`block py-2 px-3 md:p-0 rounded ${location.pathname === '/about' ? (isScrolled ? 'text-gray-200 hover:bg-gray-100' : 'text-white bg-indigo-700 md:bg-transparent md:text-indigo-700 md:dark:text-indigo-500') : (isScrolled ? 'text-gray-900 hover:bg-gray-100' : 'text-gray-900 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700')}`}>About</Link>
                    </li>
                    <li>
                      <Link to="/pricing" className={`block py-2 px-3 md:p-0 rounded ${location.pathname === '/pircing' ? (isScrolled ? 'text-gray-200 hover:bg-gray-100' : 'text-white bg-indigo-700 md:bg-transparent md:text-indigo-700 md:dark:text-indigo-500') : (isScrolled ? 'text-gray-900 hover:bg-gray-100' : 'text-gray-900 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700')}`}>Pricing</Link>
                    </li>
                    <li>
                      <Link to="/contact" className={`block py-2 px-3 md:p-0 rounded ${location.pathname === '/contact' ? (isScrolled ? 'text-gray-200 hover:bg-gray-100' : 'text-white bg-indigo-700 md:bg-transparent md:text-indigo-700 md:dark:text-indigo-500') : (isScrolled ? 'text-gray-900 hover:bg-gray-100' : 'text-gray-900 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700')}`}>Contact</Link>
                    </li>
                  </ul>
                </div>
              </div>
